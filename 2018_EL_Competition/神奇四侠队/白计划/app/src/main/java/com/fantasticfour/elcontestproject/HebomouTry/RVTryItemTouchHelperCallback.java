...
public class RVTryItemTouchHelperCallback extends ItemTouchHelper.Callback {
    private RVTryAdapter m_Adapter;
    private boolean m_BeDragEnabled = true;
    public RVTryItemTouchHelperCallback(RVTryAdapter adapter){
        m_Adapter = adapter;
    }
