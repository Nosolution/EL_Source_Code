...
public class StudyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initMediaPlayer();
        ////
        bt=(Button)findViewById(R.id.study_main);
        bt.setEnabled(false);
        final SemicircleMenu mSemicircleMenu = (SemicircleMenu) findViewById(R.id.circlemenu);

        stop=(Button)findViewById(R.id.stop_study);
        pause=(Button)findViewById(R.id.pause_study);
        continue1=(Button)findViewById(R.id.continue_study);
        ...
        pause.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //Toast.makeText(StudyActivity.this,"end:"+pref.getInt("end",0),Toast.LENGTH_SHORT).show();
            }
        });
        ...
        continue1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                editor.apply();
                //Toast.makeText(StudyActivity.this,"start:"+(int)(countDownView.getmCurrentProgress()/120*m),Toast.LENGTH_SHORT).show();
            }
        });
        ...
        mSemicircleMenu.setOnMenuItemClickListener(new SemicircleMenu.OnMenuItemClickListener() {
            ...
            public void itemClick(View view, int pos) {
                ...
                Toast.makeText(StudyActivity.this, mItemTexts[pos], Toast.LENGTH_SHORT).show();
