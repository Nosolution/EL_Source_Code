...
public class SportActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initMediaPlayer();
        ////
        bt=(Button)findViewById(R.id.sport_main);
        bt.setEnabled(false);
        final SemicircleMenu mSemicircleMenu = (SemicircleMenu) findViewById(R.id.circlemenu);

        stop=(Button)findViewById(R.id.stop_sport);
        pause=(Button)findViewById(R.id.pause_sport);
        continue1=(Button)findViewById(R.id.continue_sport);
        ...
        pause.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //Toast.makeText(SportActivity.this,"end:"+pref.getInt("end",0),Toast.LENGTH_SHORT).show();
            }
        });
        ...
        continue1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                editor.apply();
                //Toast.makeText(SportActivity.this,"start:"+(int)(countDownView.getmCurrentProgress()/120*m),Toast.LENGTH_SHORT).show();
            }
        });
        ...
        mSemicircleMenu.setOnMenuItemClickListener(new SemicircleMenu.OnMenuItemClickListener() {
            ...
            public void itemClick(View view, int pos) {
                ...
                Toast.makeText(SportActivity.this, mItemTexts[pos], Toast.LENGTH_SHORT).show();
                ...
                countDownView.setAddCountDownListener(new CountDownView.OnCountDownFinishListener() {
                    ...
                    public void countDownFinished() {
                        ...
                        mediaPlayer.reset();
                        initMediaPlayer();
                        Toast.makeText(SportActivity.this, "倒计时结束", Toast.LENGTH_SHORT).show();
