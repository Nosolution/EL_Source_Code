...
public class PlayerController {
    ...
    //控件素材图片
    private String playIcon  = getClass().getClassLoader().getResource("el/media/res/icon/play.png").toString();
    private String pauseIcon  = getClass().getClassLoader().getResource("el/media/res/icon/pause.png").toString();
    private String stopIcon  = getClass().getClassLoader().getResource("el/media/res/icon/stop.png").toString();
    private String volOffIcon  = getClass().getClassLoader().getResource("el/media/res/icon/volume_off.png").toString();
    private String volOnIcon  = getClass().getClassLoader().getResource("el/media/res/icon/volume_On.png").toString();
    private String maxIcon  = getClass().getClassLoader().getResource("el/media/res/icon/max.png").toString();
